...
class KeyType:
    ...
    user_id = to_4byte(7, 0x60)
    transaction_id = to_4byte(8, 0x60)
    asset_group_id = to_4byte(9, 0x60)
    asset_group_ids = to_4byte(10, 0x60)
    asset_id = to_4byte(11, 0x60)

    transaction_data = to_4byte(0, 0x70)
    transactions = to_4byte(1, 0x70)
    ref_index = to_4byte(2, 0x70)
    all_asset_files = to_4byte(3, 0x70)
    signature = to_4byte(4, 0x70)
    cross_refs = to_4byte(5, 0x70)
    compromised_transaction_data = to_4byte(6, 0x70)
    compromised_transactions = to_4byte(7, 0x70)
    compromised_asset_files = to_4byte(8, 0x70)
